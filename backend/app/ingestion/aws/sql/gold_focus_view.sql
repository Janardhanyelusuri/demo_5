...
BEGIN
    ...
    FOR record_tagkey IN
        SELECT DISTINCT jsonb_object_keys("Tags"::jsonb) AS tagkey FROM __schema__.silver_focus_aws
    LOOP
...
-- SELECT * FROM __schema__.gold_aws_fact_focus limit 100;
-- select * from __schema__.gold_aws_tags;
