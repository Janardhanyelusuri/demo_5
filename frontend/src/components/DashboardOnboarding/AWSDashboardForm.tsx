...
interface AWSDashboardFormProps {
  projectName: string | null;
  providerName: string;
  onBack: () => void;
}

const AWSDashboardForm: React.FC<AWSDashboardFormProps> = ({
  projectName,
  providerName,
  onBack,
}) => {
  ...
  return (
    <div className="shadow-md border border-[#E0E5EF] rounded-md h-[550px] mb-9 bg-white flex flex-col">
      <div className="flex items-center gap-4 w-[600px] bg-[#EDEFF2] pl-2 mb-6 rounded-t-md">
        <Image className="mt-1 p-2" src={AWS} alt="AWS" width={50} height={50} />
...
export default AWSDashboardForm;
