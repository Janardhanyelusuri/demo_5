...
import styles from "./AzureDashboardForm.module.css";
...
interface AzureDashboardFormProps {
  projectName: string | null;
  providerName: string;
  onBack: () => void;
}

const AzureDashboardForm: React.FC<AzureDashboardFormProps> = ({
  projectName,
  providerName,
  onBack,
}) => {
...
export default AzureDashboardForm;
