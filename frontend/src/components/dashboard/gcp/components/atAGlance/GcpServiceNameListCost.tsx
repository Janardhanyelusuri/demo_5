...
const GcpServiceNameListCost: React.FC<Props> = ({ projectId }) => {
  ...
  const sortedData = response
    .map((item) => ({
      name: item["gcp_service_dim.service_name"],
  ...
  return (
    <div className="h-full w-full bg-white rounded-lg shadow-md p-4 border flex flex-col">
      <h2 className="mb-4 text-lg">Service Name List Cost</h2>
...
export default GcpServiceNameListCost;
