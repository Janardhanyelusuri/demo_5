...
const costComponents = [
	{
		cloudPlatform: "azure",
		queryType: "azure_vs_month_to_date_cost",
		costField: "azure_fact_cost.vs_month_to_date_cost",
		label: "VS Month to Date Cost",
	},
	{
		cloudPlatform: "azure",
		queryType: "azure_vs_quarter_to_date_cost",
		costField: "azure_fact_cost.vs_quarter_to_date_cost",
		label: "VS Quarter to Date Cost",
	},
	{
		cloudPlatform: "azure",
		queryType: "azure_vs_year_to_date_cost",
		costField: "azure_fact_cost.vs_year_to_date_cost",
		label: "VS Year to Date Cost",
	},
];
		...
		<div>
			<div className="bg-cp-card shadow-md rounded-md border border-cp-border w-full h-full overflow-y-auto p-4 space-y-4">
				...
				<div className="h-[300px] items-center justify-center flex">
					<BarChartComponent
						title="VS COST BY REGIONS"
						cloudPlatform="azure"
						queryType="azure_cost_by_region_vs"
						projectId={projectId}
				...
				<div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
					...
					<div className="h-[400px] items-center justify-center flex">
						<PieChartComponent
							title="VS COST BY SKU METER NAME"
							cloudPlatform="azure"
							queryType="azure_cost_by_sku_vs"
							projectId={projectId}
