...
const costComponents = [
	{
		cloudPlatform: "azure",
		queryType: "azure_monitor_month_to_date_cost",
		costField: "azure_fact_cost.monitor_month_to_date_cost",
		label: "Azure Monitor Month to Date Cost",
	},
	{
		cloudPlatform: "azure",
		queryType: "azure_monitor_quarter_to_date_cost",
		costField: "azure_fact_cost.monitor_quarter_to_date_cost",
		label: "Azure Monitor Quarter to Date Cost",
	},
	{
		cloudPlatform: "azure",
		queryType: "azure_monitor_year_to_date_cost",
		costField: "azure_fact_cost.monitor_year_to_date_cost",
		label: "Azure Monitor Year to Date Cost",
	},
];
		...
		<div>
			<div className="bg-cp-card shadow-md rounded-md border border-cp-border w-full h-full overflow-y-auto p-4 space-y-4">
				...
				<div className="h-[400px] items-center justify-center flex">
					<LineChartComponent
						title="AZURE MONITOR COST OVER TIME"
						cloudPlatform="azure"
						queryType="azure_cost_by_time_monitor"
						projectId={projectId}
				...
				<div className="h-[400px] items-center justify-center flex">
					<BarChartComponent
						title="AZURE MONITOR COST BY REGIONS"
						cloudPlatform="azure"
						queryType="azure_cost_by_region_monitor"
						projectId={projectId}
				...
				<div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
					<div className="h-[400px] items-center justify-center flex">
						<PieChartComponent
							title="AZURE MONITOR COST BY INSTANCES"
							cloudPlatform="azure"
							queryType="azure_cost_by_instance_monitor"
							projectId={projectId}
					...
					<div className="h-[400px] items-center justify-center flex">
						<PieChartComponent
							title="AZURE MONITOR COST BY SKU METER NAME"
							cloudPlatform="azure"
							queryType="azure_cost_by_sku_monitor"
							projectId={projectId}
