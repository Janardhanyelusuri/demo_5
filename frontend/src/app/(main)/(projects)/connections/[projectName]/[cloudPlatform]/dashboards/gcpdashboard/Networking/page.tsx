...
const costComponents = [
  {
    cloudPlatform: "gcp",
    queryType: "gcp_networking_year_to_date_cost",
    costField: "gcp_fact_dim.networking_year_to_date_cost",
    label: "Year to Date Cost",
  },
  {
    cloudPlatform: "gcp",
    queryType: "gcp_networking_quarter_to_date_cost",
    costField: "gcp_fact_dim.networking_quarter_to_date_cost",
    label: "Quarter to Date Cost",
  },
  {
    cloudPlatform: "gcp",
    queryType: "gcp_networking_month_to_date_cost",
    costField: "gcp_fact_dim.networking_month_to_date_cost",
