...
const costComponents = [
  {
    cloudPlatform: "aws",
    queryType: "cloud_watch_month_to_date_cost",
    costField: "aws_fact_cost.cloud_watch_month_to_date_cost",
    label: "cloud_watch Month to Date Cost",
  },
  {
    cloudPlatform: "aws",
    queryType: "cloud_watch_quarter_to_date_cost",
    costField: "aws_fact_cost.cloud_watch_quarter_to_date_cost",
    label: "cloud_watch Quarter to Date Cost",
  },
  {
    cloudPlatform: "aws",
    queryType: "cloud_watch_year_to_date_cost",
    costField: "aws_fact_cost.cloud_watch_year_to_date_cost",
    label: "cloud_watch Year to Date Cost",
  },
];
  ...
  return (
    <div className="bg-white shadow-md rounded-md border w-full h-full overflow-y-auto p-4 space-y-4">
      ...
      <div className="h-[400px] items-center justify-center flex">
        <LineChartComponent
          title="AWS Cost by Time Cloud Watch"
          cloudPlatform="aws"
          queryType="aws_cost_by_time_cloud_watch"
          projectId={projectId}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        <div className="h-[300px] items-center justify-center flex">
          <PieChartComponent
            title="Aws Cost by Region Cloud Watch"
            cloudPlatform="aws"
            queryType="aws_cost_by_region_cloud_watch"
            projectId={projectId}
        ...
        <div className="h-[300px] items-center justify-center flex">
          <PieChartComponent
            title="Aws Cost by Instance Cloud Watch"
            cloudPlatform="aws"
