...
const costComponents = [
  {
    cloudPlatform: "aws",
    queryType: "cost_explorer_month_to_date_cost",
    costField: "aws_fact_cost.cost_explorer_month_to_date_cost",
    label: "cost explorer Month to Date Cost",
  },
  {
    cloudPlatform: "aws",
    queryType: "cost_explorer_quarter_to_date_cost",
    costField: "aws_fact_cost.cost_explorer_quarter_to_date_cost",
    label: "cost explorer Quarter to Date Cost",
  },
  {
    cloudPlatform: "aws",
    queryType: "cost_explorer_year_to_date_cost",
    costField: "aws_fact_cost.cost_explorer_year_to_date_cost",
    label: "cost explorer Year to Date Cost",
  },
];
  ...
  return (
    <div className="bg-white shadow-md rounded-md border w-full h-full overflow-y-auto p-4 space-y-4">
      ...
      <div className="h-[400px] items-center justify-center flex">
        <LineChartComponent
          title="AWS Cost by Time EC2"
          cloudPlatform="aws"
          queryType="aws_cost_by_time_cost_explorer"
          projectId={projectId}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-1 gap-4">
        <div className="h-[300px] items-center justify-center flex">
          <BarChartComponent
            title="Aws Cost by Region EC2"
            cloudPlatform="aws"
            queryType="aws_cost_by_region_cost_explorer"
            projectId={projectId}
        ...
        {/* <div className="h-[300px] items-center justify-center flex">
          <PieChartComponent
            title="Aws Cost by Instance EC2"
            cloudPlatform="aws"
            queryType="aws_cost_by_instance_cost_explorer"
            projectId={projectId}
