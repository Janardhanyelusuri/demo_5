...
const costComponents = [
  {
    cloudPlatform: "gcp",
    queryType: "gcp_kms_year_to_date_cost",
    costField: "gcp_fact_dim.kms_year_to_date_cost",
    label: "Year to Date Cost",
  },
  {
    cloudPlatform: "gcp",
    queryType: "gcp_kms_quarter_to_date_cost",
    costField: "gcp_fact_dim.kms_quarter_to_date_cost",
    label: "Quarter to Date Cost",
  },
  {
    cloudPlatform: "gcp",
    queryType: "gcp_kms_month_to_date_cost",
    costField: "gcp_fact_dim.kms_month_to_date_cost",
