...
const costComponents = [
  {
    cloudPlatform: "azure",
    queryType: "azure_databricks_month_to_date_cost",
    costField: "azure_fact_cost.databricks_month_to_date_cost",
    label: "Databricks Month To Date Cost",
  },
  {
    cloudPlatform: "azure",
    queryType: "azure_databricks_quarter_to_date_cost",
    costField: "azure_fact_cost.databricks_quarter_to_date_cost",
    label: "Databricks Quarter To Date Cost",
  },
  {
    cloudPlatform: "azure",
    queryType: "azure_databricks_year_to_date_cost",
    costField: "azure_fact_cost.databricks_year_to_date_cost",
    label: "Databricks Year To Date Cost",
  },
];
    ...
    <div>
      <div className="bg-cp-card shadow-md rounded-md border border-cp-border w-full h-full overflow-y-auto p-4 space-y-4">
        ...
        <div className="h-[400px] items-center justify-center flex">
          <LineChartComponent
            title="DATABRICKS COST OVER TIME"
            cloudPlatform="azure"
            queryType="azure_cost_by_time_databricks"
            projectId={projectId}
        ...
        <div className="h-[400px] items-center justify-center flex mb-4">
            <BarChartComponent
              title="DATABRICKS COST BY REGIONS"
              cloudPlatform="azure"
              queryType="azure_cost_by_region_databricks"
              projectId={projectId}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
          <div className="h-[400px] items-center justify-center flex">
            <PieChartComponent
              title="DATABRICKS COST BY INSTANCES"
              cloudPlatform="azure"
              queryType="azure_cost_by_instance_databricks"
              projectId={projectId}
          ...
          <div className="h-[400px] items-center justify-center flex">
          <PieChartComponent
            title="DATABRICKS COST BY SKU METER NAME"
            cloudPlatform="azure"
            queryType="azure_cost_by_sku_databricks"
            projectId={projectId}
