...
const costComponents = [
  {
    cloudPlatform: "gcp",
    queryType: "gcp_bq_year_to_date_cost",
    costField: "gcp_fact_dim.bq_year_to_date_cost",
    label: "Year to Date Cost",
  },
  {
    cloudPlatform: "gcp",
    queryType: "gcp_bq_quarter_to_date_cost",
    costField: "gcp_fact_dim.bq_quarter_to_date_cost",
