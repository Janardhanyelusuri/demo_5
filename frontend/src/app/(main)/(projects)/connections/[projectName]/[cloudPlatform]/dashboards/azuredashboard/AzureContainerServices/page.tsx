...
const costComponents = [
	{
		cloudPlatform: "azure",
		queryType: "azure_container_registry_month_to_date_cost",
		costField: "azure_fact_cost.container_registry_month_to_date_cost",
		label: "Container Registry Month to Date Cost",
	},
	{
		cloudPlatform: "azure",
		queryType: "azure_container_registry_quarter_to_date_cost",
		costField: "azure_fact_cost.container_registry_quarter_to_date_cost",
		label: "Container Registry Quarter to Date Cost",
	},
	{
		cloudPlatform: "azure",
		queryType: "azure_container_registry_year_to_date_cost",
		costField: "azure_fact_cost.container_registry_year_to_date_cost",
		label: "Container Registry Year to Date Cost",
	},
];
		...
		<div>
			<div className="bg-cp-card shadow-md rounded-md border border-cp-border w-full h-full overflow-y-auto p-4 space-y-4">
				...
				<div className="h-[400px] items-center justify-center flex">
					<LineChartComponent
						title="CONTAINER REGISTRY COST OVER TIME"
						cloudPlatform="azure"
						queryType="azure_cost_by_time_container_registry"
						projectId={projectId}
				...
				<div className="h-[400px] items-center justify-center flex">
					<BarChartComponent
						title="CONTAINER REGISTRY COST BY REGIONS"
						cloudPlatform="azure"
						queryType="azure_cost_by_region_container_registry"
						projectId={projectId}
				...
				<div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
					...
					<div className="h-[400px] items-center justify-center flex">
						<PieChartComponent
							title="CONTAINER REGISTRY COST BY SKU METER NAME"
							cloudPlatform="azure"
							queryType="azure_cost_by_sku_container_registry"
							projectId={projectId}
