...
const costComponents = [
  {
    cloudPlatform: "gcp",
    queryType: "gcp_logging_year_to_date_cost",
    costField: "gcp_fact_dim.logging_year_to_date_cost",
    label: "Year to Date Cost",
  },
  {
    cloudPlatform: "gcp",
    queryType: "gcp_logging_quarter_to_date_cost",
    costField: "gcp_fact_dim.logging_quarter_to_date_cost",
    label: "Quarter to Date Cost",
  },
  {
    cloudPlatform: "gcp",
    queryType: "gcp_logging_month_to_date_cost",
    costField: "gcp_fact_dim.logging_month_to_date_cost",
