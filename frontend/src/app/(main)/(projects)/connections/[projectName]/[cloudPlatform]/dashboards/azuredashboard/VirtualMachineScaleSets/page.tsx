...
const costComponents = [
  {
    cloudPlatform: "azure",
    queryType: "azure_vmss_month_to_date_cost",
    costField: "azure_fact_cost.vmss_month_to_date_cost",
    label: "VMSS Month to Date Cost",
  },
  {
    cloudPlatform: "azure",
    queryType: "azure_vmss_quarter_to_date_cost",
    costField: "azure_fact_cost.vmss_quarter_to_date_cost",
    label: " VMSS Quarter to Date Cost",
  },
  {
    cloudPlatform: "azure",
    queryType: "azure_vmss_year_to_date_cost",
    costField: "azure_fact_cost.vmss_year_to_date_cost",
    label: "VMSS Year to Date Cost",
  },
  // {
  //   cloudPlatform: "azure",
  //   queryType: "azure_cost_by_region_vmss",
  //   costField: "azure_fact_cost.total_billed_cost",
  //   label: "Cost by Region VMSS",
  // },
];
    ...
    <div>
      <div className="bg-cp-card shadow-md rounded-md border border-cp-border w-full h-full overflow-y-auto p-4 space-y-4">
        ...
        <div className="h-[400px] items-center justify-center flex">
          <LineChartComponent
            title="VMSS COST OVER TIME"
            cloudPlatform="azure"
            queryType="azure_cost_by_time_vmss"
            projectId={projectId}
            xKey="azure_fact_cost.charge_period_start"
            yKey="azure_fact_cost.total_billed_cost"
            name="Cost by Time VMSS"
        ...
        <div className="h-[400px] items-center justify-center flex">
        <PieChartComponent
              title="VMSS COST BY INSTANCES"
              cloudPlatform="azure"
              queryType="azure_cost_by_instance_vmss"
              projectId={projectId}
          ...
          <div className="h-[400px] items-center justify-center flex">
          <PieChartComponent
            title="VMSS COST BY SKU METER NAME"
            cloudPlatform="azure"
            queryType="azure_cost_by_sku_vmss"
            projectId={projectId}
