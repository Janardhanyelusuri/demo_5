...
const costComponents = [
  {
    cloudPlatform: "gcp",
    queryType: "gcp_areg_year_to_date_cost",
    costField: "gcp_fact_dim.areg_year_to_date_cost",
    label: "Year to Date Cost",
  },
  {
    cloudPlatform: "gcp",
    queryType: "gcp_areg_quarter_to_date_cost",
    costField: "gcp_fact_dim.areg_quarter_to_date_cost",
    label: "Quarter to Date Cost",
  },
  {
    cloudPlatform: "gcp",
    queryType: "gcp_areg_month_to_date_cost",
    costField: "gcp_fact_dim.areg_month_to_date_cost",
