...
const costComponents = [
  {
    cloudPlatform: "aws",
    queryType: "ecr_month_to_date_cost",
    costField: "aws_fact_cost.ecr_month_to_date_cost",
    label: "ecr Month to Date Cost",
  },
  {
    cloudPlatform: "aws",
    queryType: "ecr_quarter_to_date_cost",
    costField: "aws_fact_cost.ecr_quarter_to_date_cost",
    label: "ecr Quarter to Date Cost",
  },
  {
    cloudPlatform: "aws",
    queryType: "ecr_year_to_date_cost",
    costField: "aws_fact_cost.ecr_year_to_date_cost",
    label: "ecr Year to Date Cost",
  },
];
  ...
  return (
    <div className="bg-white shadow-md rounded-md border w-full h-full overflow-y-auto p-4 space-y-4">
      ...
      <div className="h-[400px] items-center justify-center flex">
        <LineChartComponent
          title="AWS Cost by Time ECR"
          cloudPlatform="aws"
          queryType="aws_cost_by_time_ecr"
          projectId={projectId}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        <div className="h-[300px] items-center justify-center flex">
          <PieChartComponent
            title="Aws Cost by Region ECR"
            cloudPlatform="aws"
            queryType="aws_cost_by_region_ecr"
            projectId={projectId}
        ...
        <div className="h-[300px] items-center justify-center flex">
          <PieChartComponent
            title="Aws Cost by Instance ECR"
            cloudPlatform="aws"
            queryType="aws_cost_by_instance_ecr"
            projectId={projectId}
