...
const costComponents = [
  {
    cloudPlatform: "gcp",
    queryType: "gcp_kubengine_year_to_date_cost",
    costField: "gcp_fact_dim.kubengine_year_to_date_cost",
    label: "Year to Date Cost",
  },
  {
    cloudPlatform: "gcp",
    queryType: "gcp_kubengine_quarter_to_date_cost",
    costField: "gcp_fact_dim.kubengine_quarter_to_date_cost",
    label: "Quarter to Date Cost",
  },
  {
    cloudPlatform: "gcp",
    queryType: "gcp_kubengine_month_to_date_cost",
    costField: "gcp_fact_dim.kubengine_month_to_date_cost",
